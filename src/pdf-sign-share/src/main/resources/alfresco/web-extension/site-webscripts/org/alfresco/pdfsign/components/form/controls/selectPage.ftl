...
scheme provided by the server
 -->
<script type="text/javascript" src="${url.context}/res/pdfsign/components/selectpage/selectpage.js"></script>
...
var SelectPage = new PDFSign.SelectPage("${fieldHtmlId}").setOptions(
	      {
